...
<div class="container">
  ...
  <font color="Magenta" face="Times New Roman" size="20pt"><div align="left"><u>Ratings<u></div></font>&nbsp;
  ...
  <form method = "post" action = "sdmrser">
  	...
  	<ul>
        <li>
          <input class="btn btn-submit" type="submit" value="Generate Ratings" />
          &nbsp;
          &nbsp;          
        </li>        
	</ul>
  ...
  <form method = "post" action="sdmbcser">
  
  	<ul>
        <li>
          <input class="btn btn-submit" type="submit" value="Plot Bell Curve" />
          &nbsp;
          &nbsp;          
        </li>        
	</ul>
